...
import net.onlineutilities.request.pojos.FileDecryptionReq;
import net.onlineutilities.request.pojos.FileEncryptionReq;
import net.onlineutilities.request.pojos.TextDecryptionReq;
import net.onlineutilities.request.pojos.TextEncryptReq;
